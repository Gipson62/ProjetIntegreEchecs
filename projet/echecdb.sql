...
CREATE TABLE FriendShip (
                            ...
                            FOREIGN KEY (Friend_1) REFERENCES Account(id) ON UPDATE CASCADE ON DELETE CASCADE,
                            FOREIGN KEY (Friend_2) REFERENCES Account(id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE `Match` (
                         ...
                         FOREIGN KEY (player_black) REFERENCES Account(id) ON DELETE CASCADE,
                         FOREIGN KEY (player_white) REFERENCES Account(id) ON DELETE CASCADE,
